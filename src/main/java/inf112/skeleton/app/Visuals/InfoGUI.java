...
public class InfoGUI {
    ...
    public InfoGUI(Board board, Batch batch, Stage stage, AssetHandler assetHandler) {
        this.batch = batch;
        this.stage = stage;
    ...
    public void update() {
        ...
        for (int i = 0; i < playerLabels.length; i++) {
            ...
            for (int j = 0; j < 10; j++) {
                ...
                if (j <= playerDamage - 1) {
                    table.add(getDamageTokenImage(assetHandler.getTexture("damageBar.png"))).width(20).height(10);
                } else {
                    table.add(getDamageTokenImage(assetHandler.getTexture("emptyDamageBar.png"))).width(20).height(10);
                }
            }
